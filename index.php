...
<head>
    ...
    <link rel="stylesheet" href="aplicacion/css/estilo_home.css">
...
<div class="contenedor">
    <a href="#" type="button" class="button" onclick="ir()">
        <figure>
            <img src="aplicacion/css/celendario.svg">
            <div class="capa">
    ...
    <a href="php/login.php" type="button" class="button1" onclick="ir2()">
        <figure>
            <img src="aplicacion/css/documentos.svg">
            <div class="capa">
                <h3>Sistema de administracion de documentos</h3>
                <p>Administrador y gestor de documentos y archivos de personal escolar.</p>
            </div>
        </figure>
    </a>
    <a href="#" type="button" class="button2" onclick="ir3()">
        <figure>
            <img src="aplicacion/css/inventario.svg">
            <div class="capa">
