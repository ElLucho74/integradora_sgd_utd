...
$entrar="";
$consulta = "select * from archivos where tipo_documento='planeaciones'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($extension_archivo == "doc" || $extension_archivo == "docx" || $extension_archivo == "ppt" || $extension_archivo == "pptx" || $extension_archivo == "xls" || $extension_archivo == "xlsx" || $extension_archivo == "pdf") {
      ...
      $consulta = "INSERT INTO archivos (id_archivos, tipo_documento, fecha_hora, size, ruta, extension, docente, nom_archivos, carrera) VALUES (null,'planeaciones', CURRENT_TIMESTAMP,'$size_archivo','$ruta_archivo','$extension_archivo','$rfc','$nombre_archivo','$id_carrera')";
      $resultado = $conexion->query($consulta);
...
<body>
	...
	<header class="header">
		...
		<div class="btn-menu">            
			...
			<div class="logo">
				<img src="../css/bufalo.png" width="120px" height="100"> 
			</div>			
			<nav class="menu">
...
<section>
  ...
  <hr>
  <a class="enlace" href='visualizar.php'>
...
?>
  <br><br>
  <center>
  <h3 align=center> Registros de Planeaciones en el Sistema</h3>
  <hr>
  <table align=center border=1>
    <tr>
      ...
      <td class="categorias">Fecha y Hora</td>
